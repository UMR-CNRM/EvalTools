...
Resulting charts are used when compiling the documentation.
...
# plt.rcParams['legend.framealpha'] = .4
# plt.rcParams['legend.facecolor'] = '#D9D9E1'
...
print("plot_quarterly_score")
for i in range(1, 4):
    last_quarter = evt.quarter.Quarter(
        start_date=date(2017, 1, 1),
        end_date=date(2017, 3, 31))
    ser = pd.Series(
        abs(np.random.normal(loc=i, size=6)),
        index=last_quarter.range(evt.quarter.Quarter.from_string("OND2015")),
        name='RMSE')
    ser.to_csv("../doc/source/charts/kpi{}.csv".format(i), sep=' ',
               na_rep='nan', float_format='%g', header=True, index=True,
               date_format='%Y%m%d%H')

# evt.plotting.plot_quarterlyMedianScore(
#     ["../doc/source/charts/kpi1.csv",
#      "../doc/source/charts/kpi2.csv",
#      "../doc/source/charts/kpi3.csv"],
#     labels=['model1', 'model2', 'model3'],
#     outputFile="../doc/source/charts/quarterlyMedianScore",
#     title="Median of a score computed at every stations\n\n",
#     colors=[model_colors[model] for model in model_list],
#     linestyles=['-']*len(model_list),
#     markers=[model_markers[model] for model in model_list],
#     last_quarter=evt.quarter.Quarter(date(2017, 1, 1),
#                                      date(2017, 3, 31)).string,
#     first_quarter="OND2015",
#     score='RMSE', thres=None, file_formats=['png'], ylabel=None,
#     origin_zero=True, black_axes=True)

evt.plotting.plot_quarterly_score(
    ["../doc/source/charts/kpi1.csv",
     "../doc/source/charts/kpi2.csv",
     "../doc/source/charts/kpi3.csv"],
    labels=['model1', 'model2', 'model3'],
    output_file="../doc/source/charts/quarterlyMedianScore",
    title="Median of a score computed at every stations\n\n",
    colors=[model_colors[model] for model in model_list],
    linestyles=['-']*len(model_list),
    markers=[model_markers[model] for model in model_list],
...
evt.plotting.plot_time_series(
    ...
    xticking='daily',
    output_file="../doc/source/charts/time_series",
)
evt.plotting.plot_time_series(
    ...
    output_file="../doc/source/charts/time_series_quartiles",
)
...
evt.plotting.plot_average_ft_scores(
    ...
    black_axes=True,
    outlier_thresh=3.5,
    output_file="../doc/source/charts/average_ft_scores",
    file_formats=['png'],
    colors=None,
    linestyles=None,
    markers=['o', 's'],
    score_name="Temporal Root Mean Square Error",
    min_nb_sta=10,
...
evt.plotting.plot_time_scores(
    ...
    output_file="../doc/source/charts/time_scores",
)
...
evt.plotting.plot_station_scores(
    ...
    output_file="../doc/source/charts/station_scores_interp",
    interp2d=True,
    bbox_inches='tight',
)
evt.plotting.plot_station_scores(
    ...
    output_file="../doc/source/charts/station_scores",
    bbox_inches='tight',
)
evt.plotting.plot_station_scores(
    ...
    mark_by=('area', {'urb': 's', 'rur': 'o', 'sub': '^'}),
    output_file="../doc/source/charts/station_scores_diff",
    bbox_inches='tight',
    cmap='Spectral',
)
...
evt.plotting.plot_taylor_diagram(
    ...
    output_file="../doc/source/charts/taylor_diagram",
)
...
evt.plotting.plot_comparison_scatter_plot(
    ...
    output_file="../doc/source/charts/comparison_scatter_plot",
    output_csv=None,
)
...
evt.plotting.plot_significant_differences(
    ...
    output_file="../doc/source/charts/significant_differences",
)
...
evt.plotting.plot_diurnal_cycle(
    ...
    output_file="../doc/source/charts/diurnal_cycle_quartiles",
)
...
evt.plotting.plot_score_density(
    ...
    output_file="../doc/source/charts/score_density",
    # file_formats=['png'],
)
...
evt.plotting.plot_score_box(
    ...
    nb_stations=True,
    # annotation='annotation',
    output_file="../doc/source/charts/score_box",
    file_formats=['png'],
)
...
evt.plotting.plot_data_density(
    ...
    # annotation='annotation',
    # black_axes=True,
    output_file="../doc/source/charts/data_density",
)
...
evt.plotting.plot_data_box(
    ...
    # annotation='annotation',
    file_formats=['png'],
    output_file="../doc/source/charts/data_box",
)
...
with plt.rc_context({'figure.figsize': (11, 5)}):
    evt.fairmode.plot_target_diagram(
        objs['ENS'],
        file_formats=['png'],
        output_file="../doc/source/charts/target",
    )
...
evt.fairmode.plot_forecast_target_diagram(
    objs['ENS'],
    file_formats=['png'],
    output_file="../doc/source/charts/forecast_target",
)
...
with plt.style.context('default'):
    evt.fairmode.plot_fairmode_summary(
        ...
        availability_ratio=0.75,
        forecast_day=0,
        output_file="../doc/source/charts/summary",
        file_formats=['png'],
    )
...
evt.plotting.plot_bar_scores(
    ...
    output_file="../doc/source/charts/bar_scores",
    file_formats=['png'],
    availability_ratio=0.75,
)
...
evt.plotting.plot_bar_exceedances(
    ...
    output_file="../doc/source/charts/bar_exceedances",
...
evt.plotting.plot_bar_contingency_table(
    ...
    start_end=None,
    title="",
    output_file="../doc/source/charts/bar_contingency_table",
)
...
evt.plotting.plot_line_exceedances(
    ...
    linestyles=None,
    markers=None,
    output_file="../doc/source/charts/line_exceedances",
    title="",
...
evt.plotting.plot_values_scatter_plot(
    ...
    xlabel='observations',
    ylabel='simulations',
    output_file="../doc/source/charts/values_scatter_plot",
)
...
evt.plotting.plot_performance_diagram(
    objs.values(),
    threshold=20,
    output_file="../doc/source/charts/performance_diagram",
)
...
evt.plotting.plot_roc_curve(
    ...
    output_file="../doc/source/charts/roc_curve",
)
...
evt.plotting.plot_exceedances_scores(
    ...
    labels=['Ensemble', 'Mocage'],
    file_formats=['png'],
    output_file="../doc/source/charts/exceedances_scores",
    output_csv=None,
)
...
evt.plotting.plot_summary_bar_chart(
    ...
    colors_list=None,
    groups_labels=None,
    output_file="../doc/source/charts/summary_bar_chart",
    file_formats=['png'],
...
evt.plotting.plot_bar_scores_conc(
    ...
    colors=None,
    xtick_labels=None,
    output_file="../doc/source/charts/bar_scores_conc",
    file_formats=['png'],
    output_csv=None,
    min_nb_val=2,
    based_on='obs',
